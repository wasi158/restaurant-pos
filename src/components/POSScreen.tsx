...
export function POSScreen({ onCharge }: Props) {
  ...
  return (
    <div className="flex h-full min-h-0 overflow-hidden flex-col lg:flex-row">
      ...
      {/* ── Menu / items (primary) ── */}
      <div className="flex-1 flex flex-col min-h-0 min-w-0 overflow-hidden lg:min-h-0">
      ...
      <div className="flex flex-col min-h-0 border-t lg:border-t-0 lg:border-l border-outline-variant bg-surface-container-low lg:w-[min(100%,26rem)] xl:w-[28rem] 2xl:w-[30rem] shrink-0 lg:max-w-[40vw]">
