...
import { OrderStatus, Priority, KitchenItem, KitchenOrder, STATIONS, INITIAL_KITCHEN_ORDERS } from '../data/mockKitchen';
...
export function KitchenScreen() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-surface-container-lowest">
      ...
      {/* KDS Header */}
      <div className="bg-surface-container-low border-b border-outline-variant px-6 py-4 flex items-center justify-between gap-4 shrink-0">
        ...
        <div className="flex items-center gap-2">
          <div className="flex bg-surface-container-high rounded-xl p-1 border border-outline-variant gap-0.5">
            {STATIONS.map(s => (
      ...
      <div className="flex-1 overflow-hidden flex gap-0">
        {columns.map(col => {
          ...
          return (
            <div key={col.status} className="flex-1 flex flex-col border-r border-outline-variant last:border-r-0 overflow-hidden">
              {/* Column header */}
              <div className={`px-4 py-3 border-b border-outline-variant flex items-center justify-between ${cfg.headerBg}`}>
                <div className="flex items-center gap-2">
      ...
      {/* Footer ticker */}
      <div className="bg-surface-container-low border-t border-outline-variant px-6 py-2 flex items-center justify-between shrink-0">
