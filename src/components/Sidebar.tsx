...
import {
  LayoutGrid, ShoppingCart, ClipboardList, BookOpen,
  Armchair, Boxes, Truck, UsersRound, BarChart2, ContactRound,
  SendHorizonal, Settings2, LifeBuoy, ChefHat, Monitor,
  UtensilsCrossed, Tag,
} from 'lucide-react';
...
export function Sidebar({ activeTab, setActiveTab, onSendToKitchen }: SidebarProps) {
  return (
    <aside className="w-60 bg-surface-container-low h-screen flex flex-col border-r border-outline-variant z-50 shrink-0">
